...
export const VerificationModal: React.FC<VerificationModalProps> = ({ onClose, onStartVerification }) => {
    return (
        <div 
        ...
        >
            ...
            >
                ...
                <p className="text-xs text-slate-500 mb-6">
                    Você precisará tirar uma selfie rápida para compararmos com suas fotos.
                </p>
                <button
